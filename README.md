...
Chau et al. (2026) demonstrate that the differential geometry of subduction zone surfaces — specifically, mean curvature *H* and Gaussian curvature *K* computed from Slab2 depth grids — correlates significantly with earthquake productivity (Pearson *r* up to −0.64 for Mean|*K*| vs. *M*_max).  Their closing sentence calls explicitly for *"computational models and predictive frameworks for earthquake risk"* that incorporate this geometric information.
